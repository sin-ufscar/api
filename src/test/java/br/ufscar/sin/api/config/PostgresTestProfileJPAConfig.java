...
@Configuration
@EnableJpaRepositories(basePackages = { "br.ufscar.sin.api"})
@EnableTransactionManagement
@PropertySource("classpath:test-application.properties")
@PropertySource("classpath:test-hibernate.properties")
/**
 * Configuração da base de testes usando postgres
 */
public class PostgresTestProfileJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "br.ufscar.sin.api" });
